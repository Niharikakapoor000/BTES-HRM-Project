...
public class ResetOptionTest extends LaunchedApplication{
...
public void AddOption() {
	     ...
	     addButtonCss.click();
	     driver.findElement (By.id("txtUni")).sendKeys(" University");
	     	driver.findElement(By.name("txtDeg")).sendKeys("BETCH ");
	     driver.findElement(By.cssSelector("input.clearbutton[value='Reset']")).click();
}
}
